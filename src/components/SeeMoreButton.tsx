  ...
  return (
    <div className="flex justify-center py-6">
      <button
        onClick={onClick}
        className={cn(
          "flex items-center gap-4 rounded-xl bg-white/90 dark:bg-[#0d0d0d]/90 px-8 py-3 text-primary text-md font-medium backdrop-blur-sm transition-all duration-300 ease-in-out",
