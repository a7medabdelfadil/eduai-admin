          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-end">
              <button
                ...
                className="mr-4 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-blue-300"
              >
                {currentLanguage === "en"
                  ? "Cancel"
                  : currentLanguage === "ar"
              ...
              <button
                ...
                className={`rounded-lg px-4 py-2 text-sm font-medium text-white focus:outline-none focus:ring-4 ${
                  !isDirty || isUpdating
