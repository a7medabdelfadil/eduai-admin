      ...
      <Container>
        ...
        <div className="max-w-screen overflow-x-hidden rounded-xl bg-bgPrimary">
          <div className="flex flex-col gap-4 rounded-lg px-4 py-4 md:flex-row md:items-center md:justify-between">
            ...
            <Link
              href="/infrastructure/store/textbooks/add-textbooks"
            ...
            >
              {currentLanguage === "en"
                ? "Add Textbooks Resource"
                : currentLanguage === "ar"
                  ? "إضافة مورد كتب دراسية"
                  : currentLanguage === "fr"
                    ? "Ajouter une ressource de manuels"
                    : "Add Textbooks Resource"}
            </Link>
          </div>
                  ...
                  visibleData.map((item: any, index: number) => (
                    <TableRow key={index} data-index={index}>
                      ...
                      <TableCell className="flex items-center gap-3">
                        <Link
                          href={`/infrastructure/store/textbooks/edit-textbooks/${item.id}`}
