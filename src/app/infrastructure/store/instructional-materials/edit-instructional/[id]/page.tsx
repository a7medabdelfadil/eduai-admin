...
const EditDigitalResource = () => {
    ...
    const onSubmit = async (formData: any) => {
        try {
            ...
            router.push("/infrastructure/store/instructional-materials");
        } catch (err) {
        ...
        <>
            <BreadCrumbs
                breadcrumbs={[
                    ...
                    {
                        nameEn: "Edit Instructional",
                        nameAr: "تعديل تعليمي",
                        nameFr: "Modifier pédagogique",
                        href: `/infrastructure/store/instructional-materials/edit-instructional/${id}`,
                    },
                ]}
            />
            <Container>
