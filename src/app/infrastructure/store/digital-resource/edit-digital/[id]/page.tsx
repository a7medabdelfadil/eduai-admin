    ...
    const onSubmit = async (formData: any) => {
        try {
            await updateResource({
                ...
                body: {
                    ...formData,
                    resourceType: "DIGITAl_RESOURCES",
                },
            }).unwrap();
            toast.success("Resource updated successfully");
            router.push("/infrastructure/store/digital-resource");
        } catch (err: any) {
            ...
            <BreadCrumbs
                breadcrumbs={[
                    ...
                    },
                    {
                        ...
                        href: "/infrastructure/digital-resources",
                    },
                    {
                        nameEn: "Edit Resource",
                        nameAr: "تعديل مورد",
                        nameFr: "Modifier une ressource",
                        href: `/infrastructure/digital-resources/${id}`,
                    },
                ]}
            />
            <Container>
