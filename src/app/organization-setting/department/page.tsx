      ...
      <Container>
        ...
        <div className="bg-bgPrimary rounded-xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 px-4 py-4 rounded-lg">
            ...
            >
              {currentLanguage === "ar" ? "+ إضافة قسم" : currentLanguage === "fr" ? "+ Ajouter Département" : "+ Add Department"}
            </Link>
          </div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>{currentLanguage === "ar" ? "المعرف" : "ID"}</TableHead>
                  <TableHead>{currentLanguage === "ar" ? "الاختصار" : currentLanguage === "fr" ? "Abréviation" : "Abbreviation"}</TableHead>
                  <TableHead>{currentLanguage === "ar" ? "الوصف" : currentLanguage === "fr" ? "Description" : "Description"}</TableHead>
                ...
                {isLoading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={6} className="text-center py-6 text-gray-500">
                      {currentLanguage === "ar" ? "لا توجد بيانات" : currentLanguage === "fr" ? "Aucune donnée" : "No data available"}
                    </TableCell>
                  </TableRow>
                ) : (
