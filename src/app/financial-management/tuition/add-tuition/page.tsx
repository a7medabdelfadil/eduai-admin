...
const AddTuition = () => {
    const breadcrumbs = [
        ...
        { nameEn: "Add Tuition", nameAr: "إضافة مصروف", nameFr: "Ajouter des frais", href: "/financial-management/tuition/add-tuition" },
    ];
            ...
            <Container>
                <div className="-ml-1 -mt-2 mb-8 flex items-center justify-between">
                    <h1 className="text-3xl font-semibold">
                        {currentLanguage === "en" ? "Add Tuition" : currentLanguage === "ar" ? "إضافة مصروف" : "Ajouter des frais"}
                    </h1>
                </div>
