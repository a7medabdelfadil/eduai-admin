...
const EditTuition = () => {
    ...
    const breadcrumbs = [
        ...
        { nameEn: "Tuition", nameAr: "المصروفات الدراسية", nameFr: "Frais de scolarité", href: "/financial-management/tuition" },
        { nameEn: "Edit Tuition", nameAr: "تعديل مصروف", nameFr: "Modifier les frais", href: `/financial-management/tuition/edit-tuition/${id}` },
    ];
            ...
            <Container>
                <div className="-ml-1 -mt-2 mb-8 flex items-center justify-between">
                    <h1 className="text-3xl font-semibold">
                        {currentLanguage === "en" ? "Edit Tuition" : currentLanguage === "ar" ? "تعديل مصروف" : "Modifier les frais"}
                    </h1>
                </div>
                    ...
                    <div className="w-[90] rounded-xl bg-bgPrimary p-10 md:w-[80%]">
                        <div className="flex items-center justify-start gap-2">
                            ...
                            <h1 className="text-[22px] font-semibold">
                                {currentLanguage === "ar" ? "معلومات المصروف" : currentLanguage === "fr" ? "Informations sur les frais" : "Tuition Information"}
                            </h1>
                        </div>
                        ...
                        <div className="flex justify-center text-center">
                            <button type="submit" disabled={submitting} className={`w-fit rounded-xl px-4 py-2 text-[18px] text-white duration-300 ease-in hover:shadow-xl ${submitting ? "cursor-not-allowed bg-gray-400" : "bg-primary hover:bg-hover"}`}>
                                {submitting ? currentLanguage === "ar" ? "جاري الحفظ..." : currentLanguage === "fr" ? "Enregistrement..." : "Saving..." : currentLanguage === "ar" ? "حفظ" : currentLanguage === "fr" ? "Sauvegarder" : "Save"}
                            </button>
                        </div>
                    </div>
                </form>
