...
const EditInstructionalMaterials = () => {
  const breadcrumbs = [
    {
      nameEn: "Academic",
      nameAr: "أكاديمي",
    ...
    },
    {
      ...
      href: "/course/resource/facilities",
    },
    {
      nameEn: "Edit Instructional Materials",
      nameAr: "تعديل المواد التعليمية",
      nameFr: "Modifier le matériel pédagogique",
      href: "/course/resource/instructional-materials/edit-instructional-materials",
    },
  ];
          ...
          <div className="grid h-[400px] items-center justify-center gap-5 rounded-xl bg-bgPrimary p-10 sm:w-[500px] md:w-[600px] lg:w-[750px] xl:h-[500px] xl:w-[1000px]">
            <div className="flex items-center justify-start gap-2">
              ...
              <h1 className="text-[22px] font-semibold">
                {currentLanguage === "ar"
                  ? "تعديل المواد التعليمية"
                  : currentLanguage === "fr"
                    ? "Modifier le matériel pédagogique"
...
export default EditInstructionalMaterials;
