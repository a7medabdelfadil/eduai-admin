...
const AddInstructionalMaterials = () => {
  const breadcrumbs = [
    {
      nameEn: "Academic",
      nameAr: "أكاديمي",
    ...
    {
      nameEn: "Add Instructional Materials",
      nameAr: "إضافة مواد تعليمية",
      nameFr: "Ajouter du matériel pédagogique",
      href: "/course/resource/instructional-materials/add-instructional-materials",
    },
  ];
...
export default AddInstructionalMaterials;
