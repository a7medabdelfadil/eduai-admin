...
const Exams = () => {
  ...
  const translate = {
    ...
    ending: currentLanguage === "ar" ? "الانتهاء" : currentLanguage === "fr" ? "Fin" : "Ending",
    teacher: currentLanguage === "ar" ? "المعلم" : currentLanguage === "fr" ? "Enseignant" : "Teacher",
    course: currentLanguage === "ar" ? "المقرر" : currentLanguage === "fr" ? "Cours" : "Course",
    semester: currentLanguage === "ar" ? "الفصل" : currentLanguage === "fr" ? "Semestre" : "Semester",
    className: currentLanguage === "ar" ? "الصف" : currentLanguage === "fr" ? "Classe" : "Class",
    type: currentLanguage === "ar" ? "النوع" : currentLanguage === "fr" ? "Type" : "Type",
